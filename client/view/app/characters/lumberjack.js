...
const animations = {
    walk: { duration: 500, steps: new Uint8Array([0, 1, 2, 3, 0]) },
    work: { duration: 500, steps: new Uint8Array([0, 2, 0]) }
};

const animationsHead = {
    walk: { duration: 500, steps: [new THREE.Vector3(0.059, 1.489, -0.029), new THREE.Vector3(0, 1.377, -0.029), new THREE.Vector3(0.059, 1.482, -0.029), new THREE.Vector3(0, 1.374, -0.029), new THREE.Vector3(0.059, 1.489, -0.029)] },
